...
export const fakeData = {
  ...
  personal: {
    ...
    email: "chatGptWillTakeOurJobs@gmail.com",
  ...
  interests: [
    ...
    { ...models.createInterest(), iconId: "airplane", name: "Traveling" },
    { ...models.createInterest(), iconId: "popcorn", name: "Watching Horror movies" },
